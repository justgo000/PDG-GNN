...
class Logger(object):
    ...
    def output(self, args):
        ...
        filename = f'results/{args.dataset}/{args.method}/encoder_{args.encoder}.dropout_{args.dropout}.tau_{args.tau}.lr_{args.lr}.weight_decay_{args.weight_decay}.prior_{args.prior}.method_{args.our_method}.variant_{args.variant}.{datetime_now}.txt'
